...
- `pplx-q-01` | chat=chat-bacia-relevo | trilha=n1_bacia_geomorfologia | perfil=geospatial_data | alvo=dataset_discovery | status=ok | fontes_visiveis=0 | bloqueio_modelo=False
  bloqueios: links_tab_not_opened, no_links_extracted
...
- `n1_bacia_geomorfologia` | chat=chat-bacia-relevo | alvo=dataset_discovery | sessao=ok | fontes=0 | candidatos=0 | datasets=0
